"""
Source     : https://github.com/nikhilvyas/SOAP (file: soap.py)
Author     : Nikhil Vyas et al. (Vyas, Morwani, Zhao, Shapira,
            Brandfonbrener, Janson, Kakade)
Paper      : "SOAP: Improving and Stabilizing Shampoo using Adam"
            https://arxiv.org/abs/2409.11321
License    : <CHECK> — see https://github.com/nikhilvyas/SOAP/blob/main/LICENSE
Fetched on : 2026-06-02 from `main` branch
"""
